...
class LightOnCommandTest extends TestCase
{
    /**
     * Test that LightOnCommand class implements Command interface.
     */
    public function testImplementsCommandInterface(): void
    {
        $reflectionClass = new ReflectionClass(LightOnCommand::class);
    ...
    /**
     * Test properties of LightOnCommand class for access type and value type.
     */
    public function testLightOnCommandProperties(): void
    {
        $expectedResults = [
    ...
    /**
     * Test the constructor of LightOnCommand class.
     */
    public function testLightOnCommandConstructor(): void
    {
        // Create a mock Light object
        $light = $this->createMock(Light::class);

        // Create a new LightOnCommand instance
    ...
    /**
     * Test the execute() method of LightOnCommand class.
     */
    ...
    /**
     * Test the undo() method of LightOnCommand class.
     */
